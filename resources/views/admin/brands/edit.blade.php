...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.brands.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="ten" id="ten" class="form-control" value="{{ old('ten', $brand->ten) }}" required>
            @error('ten')
        ...
        <div class="mb-3">
            ...
            @if($brand->logo)
                <div class="mb-2">
                    <img src="{{ asset($brand->logo) }}" alt="Logo hiện tại" style="height:60px;">
                </div>
            @endif
        ...
        <div class="mb-3">
            ...
            <textarea name="mo_ta" id="mo_ta" class="form-control" rows="3">{{ old('mo_ta', $brand->mo_ta) }}</textarea>
            @error('mo_ta')
                <div class="text-danger small">{{ $message }}</div>
            @enderror
        </div>
