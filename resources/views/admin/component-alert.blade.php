            ...
            <div class="col-12 col-md-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning"><i class="bi bi-exclamation-triangle"></i> This is warning alert.</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-light-success color-success"><i class="bi bi-check-circle"></i> This is success alert.</div>
                        <div class="alert alert-light-warning color-warning"><i class="bi bi-exclamation-triangle"></i> This is warning alert.</div>
                        <div class="alert alert-light-danger color-danger"><i class="bi bi-exclamation-circle"></i> This is danger alert.</div>
                        <div class="alert alert-light-secondary color-secondary"><i class="bi bi-star"></i> This is secondary alert.</div>
                        <div class="alert alert-light-info color-info"><i class="bi bi-star"></i> This is info alert.</div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
