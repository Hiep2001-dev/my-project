                            ...
                            <div class="product-gallery">
                                <div class="product-gallery__thumbs-container hidden-sm hidden-xs">
                                    <div class="product-gallery__thumbs thumb-fix">
                                        ...
                                        @foreach($thumbs as $i => $thumb)
                                            <div class="product-gallery__thumb {{ $i == 0 ? 'active' : '' }}" id="imgg{{ $i+1 }}">
                                ...
                                <div class="product-image-detail box__product-gallery scroll hidden-xs">
                                    <ul id="sliderproduct" class="site-box-content slide_product">
                                        @foreach($thumbs as $i => $thumb)
                                            <li class="product-gallery-item gallery-item {{ $i == 0 ? 'current' : '' }}" id="imgg{{ $i+1 }}a">
                                                <img class="product-image-feature" src="{{ asset($thumb) }}" alt="{{ $product->ten }}">
                                            </li>
                                        @endforeach
                                    </ul>
                                    <div class="product-image__button">
                                        ...
                                        <div class="gallery-index icon-pr-fix">
                                            <span class="current">1</span> / <span class="total">{{ count($thumbs) }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-5 col-sm-12 col-xs-12 product-content-desc" id="detail-product">
                            <div class="product-content-desc-1">
                                ...
                                <div class="product-price" id="price-preview">
                                    <span class="pro-price">{{ $firstPrice ? number_format($firstPrice, 0, ',', '.') : 'Liên hệ' }}₫</span>
                                </div>
                                <form id="add-item-form" action="#" method="post" class="variants clearfix">
                                        ...
                                        <div class="selector-wrapper">
                                            ...
                                            <span class="custom-dropdown custom-dropdown--white">
                                                <select class="single-option-selector custom-dropdown__select custom-dropdown__select--white" data-option="option1" id="product-select-option-0">
                                                    @foreach($product->variations as $variation)
                                                        <option value="{{ $variation->mau_sac }}">{{ $variation->mau_sac }}</option>
                                                    @endforeach
                                                </select>
                                            </span>
                                        </div>
                                        <div class="selector-wrapper">
                                            ...
                                            <span class="custom-dropdown custom-dropdown--white">
                                                <select class="single-option-selector custom-dropdown__select custom-dropdown__select--white" data-option="option2" id="product-select-option-1">
                                                    @foreach($product->variations as $variation)
                                                        <option value="{{ $variation->size_cm }}">{{ $variation->size_cm }}</option>
                                                    @endforeach
                                                </select>
                                            </span>
                                        </div>
                                    ...
                                    <div class="selector-actions">
                                        ...
                                        <div class="wrap-addcart clearfix">
                                            <div class="row-flex">
                                                <button type="button" class="button btn-addtocart addtocart-modal">Thêm vào</button>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                                    <div class="product-block">
                                        ...
                                        <a href="{{ route('shoe.detailproduct', $related->id) }}" class="img-resize">
                                            <img src="{{ asset($relatedImage ?? 'images/no-image.png') }}" alt="{{ $related->ten }}">
                                        </a>
                                        <div class="product-detail clearfix">
                                            <div class="pro-text">
                                                <a style="color: black; font-size: 14px;text-decoration: none;" href="{{ route('shoe.detailproduct', $related->id) }}">
                                                    {{ $related->ten }}
                                                </a>
                                            </div>
                                            <div class="pro-price">
                                                <p>{{ $relatedPrice ? number_format($relatedPrice, 0, ',', '.') : 'Liên hệ' }}₫</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
